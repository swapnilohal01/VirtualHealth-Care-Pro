...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="http://localhost/chat/main/home.php" > Live chat</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="panel panel-white no-radius text-center">
        <div class="panel-body">
            ...
            <p class="cl-effect-1">
                <a href="http://localhost/project/ivstream/main/index.html" onclick="clickDiv('#list-adoc-list')">Start Meeting</a>
            </p>
        </div>
    </div>
</div>
